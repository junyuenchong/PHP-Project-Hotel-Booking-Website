...
if(!$conn){
		...
		$Email = $row['BookingID'];
				...
				echo"<td>".(($row['RoomType']==50.00)?'Single Room':'');
				echo (($row['RoomType']==150.00)?'4 Person Room':'');
				echo (($row['RoomType']==100.00)?'Double Room':'');
				echo"</td>";
				echo"<td>".$row['Quantity']."</td>";
				echo"<td>".(($row['RoomType']==50.00)?' 50.00':'');
				echo (($row['RoomType']==150.00)?'150.00':'');
				echo (($row['RoomType']==100.00)?'100.00':'');
				echo"</td>";
				echo"<td><button> <a href ='edit.php?id=$Email'>Edit</a></button></td>";
				echo"<td><button> <a href ='del.php?id=$Email'>Delete</a></button></td>";
				echo "</tr>";
				}
...
<form method="post"  action="serch.php">
	...
	<p><h1>Search:</h1><input type="text" name="search" placeholder="Search The Order Lsit" style="width: 30%" ></p>
